...
const InfoScreen = ({ navigation, Book }) => {
  console.log("The BOOK details on the top of the info screen ")
  console.log(Book)
  const book = Book
  console.log("The bookk details on the top of the info screen ")
  console.log(book)
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#4D2959" }}>
      ...
      <View style={styles.image}>
        <Image source={{ uri: book.image }} style={{ resizeMode: "contain", flex: 1 }} />
      </View>
